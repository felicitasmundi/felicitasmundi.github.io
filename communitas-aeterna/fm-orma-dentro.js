...
/* \u2b50 le tre forme del vicinato */
var VIC = [
  { k:"karma yoga", i:"serve una mano" },
...
var dati = { titolo:"", chi:"", racconto:"", prezzo:"", stato:"disponibile",
  spedisce:"io", quando:"", dove:"", quanti:"" };
...
function sinistra(){
  ...
  if(tipo==="vicinato"){
    var qv=el("div","quad"); qv.style.gridTemplateColumns="repeat(3,1fr)";
  ...
  f.appendChild(el("span",null,"<b>la foto</b><i>dagli allegati dell\u2019orma, o ne aggiungi</i>"));
  d.appendChild(f);
...
function vetrina(){
  ...
  v.appendChild(el("div","im","la foto"));
  ...
  if(tipo==="vicinato"){
    ...
    if(vic===0){
      dt.appendChild(el("span","st mezzo",
        (dati.quanti ? "0 su " + dati.quanti : "serve una mano")));
    ...
    /* \u2b50 nell\u2019Emporio si compra: il carrello, e poi Stripe. */
    dt.appendChild(el("button","comp","[ la parola del carrello ]"));
  }else{
